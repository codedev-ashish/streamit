...
import 'package:streamit_flutter/components/view_video/youtube_embed_widget.dart';
            ...
            TagExtension(
              ...
              builder: (extensionContext) {
                if (extensionContext.innerHtml.contains('yout')) {
                  return YouTubeEmbedWidget(
                    extensionContext.innerHtml.splitBetween('<div class="wp-block-embed__wrapper">', "</div>").replaceAll('<br>', '').toYouTubeId(),
                    key: ValueKey(blogId),
                  );
